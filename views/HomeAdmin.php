<?php 
 $nombre_post= new AdmineController();
$nbr_post=$nombre_post->nombre_post();
$nombre_member=new AdmineController();
$nbr_member=$nombre_member->nombre_member();
...
<div  class="min-h-[80vh]">
    <div class="px-6 mr-[5%] pt-6 2xl:container ">
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mt-20 ">
...
<path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                    ...
                    <table class="w-full text-gray-600">
                        <tbody>
                            <tr>
                                <td class="py-2">Totale Posts</td>
                                <td class="text-gray-500"><?php echo $nbr_post->nombrepost; ?></td>
                                <td>
                                   <a href="<?php echo BASE_URL; ?>AfficherPost"> <button class="rounded-full bg-sky-500/50  px-3 relative left-[50%] w-[120px]">voir
                                        details</button></a>

                                </td>
                            </tr>
                            <tr>
                                <td class="py-2  ">Totale Member</td>
                                <td class="text-gray-500"><?php echo $nbr_member->nombremember; ?></td>
                                <td>
                                <a href="<?php echo BASE_URL; ?>AfficherMember">  <button class="rounded-full bg-sky-500/50  px-3 relative left-[50%] w-[120px] xs:left-[10%] sm:px-0">voir
                                        details</button>
                                </a>
                                </td>
                            </tr>
