                    ...
                    <table class="w-full text-gray-600">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="<?php echo BASE_URL; ?>AfficherMember">  <button class="rounded-full bg-sky-500/50  px-3 relative left-[50%] w-[120px]">voir
                                        details</button>
                                </a>
                                </td>
                            </tr>
                            <!-- <tr>
                                ...
                                <td class="text-gray-500"><?php echo $nbr_post->nombrepost; ?></td>
                                <td>
                                    <button class="rounded-full bg-sky-500/50  px-3 relative left-[50%] w-[120px]">voir
                                        details</button>
