...
<div class="grid grid-flow-col gap-4 text-[#000]  mx-10">
    <img src="../../../FilleRouge/public/logoimage/sewarbladk.png" alt="">
</div> 
    <div class="flex mr-10 ">
        <a class="normal-case text-xl text-blue-800 lg:w-auto " href="<?php echo BASE_URL; ?>home">Accueil</a>
    </div>
    <div class="flex-1">
    ...
    <div class="flex-none">
        ...
        <li tabindex="0" >
                ...
                <li class=" mr-10 w-[200px]"><span>
                          <a  href="<?php echo BASE_URL; ?>AfficherPost">Tout les Post</a>
                    </li>
                    <?php foreach ($selects as $select) : ?>
                    <li class=" mr-10 w-[200px]"><span>
                          <a href="<?php echo BASE_URL; ?>?page=category&category=<?php echo $select['typecategory'] ; ?>"><?php echo $select['typecategory'] ; ?></a>
                    </li>
                     <?php endforeach ?>
